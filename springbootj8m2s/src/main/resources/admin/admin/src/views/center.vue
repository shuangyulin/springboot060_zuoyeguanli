  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='zuzhang'"  label="组长学号" prop="zuzhangxuehao">
          <el-input v-model="ruleForm.zuzhangxuehao" readonly              placeholder="组长学号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='zuzhang'"  label="组长姓名" prop="zuzhangxingming">
          <el-input v-model="ruleForm.zuzhangxingming"               placeholder="组长姓名" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="24">  
        <el-form-item v-if="flag=='zuzhang'" label="组长照片" prop="zuzhangzhaopian">
          <file-upload
          tip="点击上传组长照片"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.zuzhangzhaopian?ruleForm.zuzhangzhaopian:''"
          @change="zuzhangzuzhangzhaopianUploadChange"
          ></file-upload>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='zuzhang'"  label="所在小组" prop="suozaixiaozu">
          <el-input v-model="ruleForm.suozaixiaozu"               placeholder="所在小组" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item v-if="flag=='zuzhang'"  label="性别" prop="xingbie">
          <el-select v-model="ruleForm.xingbie" placeholder="请选择性别">
            <el-option
                v-for="(item,index) in zuzhangxingbieOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='zuzhang'"  label="联系电话" prop="lianxidianhua">
...
export default {
  ...
  mounted() {
    ...
    this.zuzhangxingbieOptions = "男,女".split(',')
  },
  methods: {
    ...
    zuzhangzuzhangzhaopianUploadChange(fileUrls) {
        this.ruleForm.zuzhangzhaopian = fileUrls;
    },
    onUpdateHandler() {
      ...
      if((!this.ruleForm.zuzhangxuehao)&& 'zuzhang'==this.flag){
        this.$message.error('组长学号不能为空');
        return
      }
      if((!this.ruleForm.mima)&& 'zuzhang'==this.flag){
        this.$message.error('密码不能为空');
        return
      }
      if( 'zuzhang' ==this.flag && this.ruleForm.lianxidianhua&&(!isMobile(this.ruleForm.lianxidianhua))){
