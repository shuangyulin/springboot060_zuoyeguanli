        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
		    ...
		    label="教师">
		     <template slot-scope="scope">
                  ...
                  <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="zuoyezhaopian"
                    header-align="center"
                    width="200"
                    label="作业照片">
                    <template slot-scope="scope">
                      <div v-if="scope.row.zuoyezhaopian">
                        <img :src="scope.row.zuoyezhaopian.split(',')[0]" width="100" height="100">
                      </div>
                      <div v-else>无图片</div>
                    </template>
                  </el-table-column>
		    ...
		    label="教师姓名">
		     <template slot-scope="scope">
                  ...
                  <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="zuoyefujian"
                    header-align="center"
                    width="200"
                    label="作业附件">
                    <template slot-scope="scope">
                      <div v-if="scope.row.zuoyefujian">
                        <img :src="scope.row.zuoyefujian.split(',')[0]" width="100" height="100">
                      </div>
                      <div v-else>无图片</div>
                    </template>
                  </el-table-column>
