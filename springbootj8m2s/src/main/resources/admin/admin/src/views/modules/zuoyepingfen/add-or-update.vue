<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.zuoyetupian" label="作业图片" prop="zuoyetupian">
          <file-upload
          tip="点击上传作业图片"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.zuoyetupian" label="作业图片" prop="zuoyetupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.zuoyetupian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="作业评分" prop="zuoyepingfen">
          <el-input v-model="ruleForm.zuoyepingfen" 
              placeholder="作业评分" clearable  :readonly="ro.zuoyepingfen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="作业评分" prop="zuoyepingfen">
              <el-input v-model="ruleForm.zuoyepingfen" 
                placeholder="作业评分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="作业评语" prop="zuoyepingyu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="作业评语"
                  v-model="ruleForm.zuoyepingyu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zuoyepingyu" label="作业评语" prop="zuoyepingyu">
                    <span>{{ruleForm.zuoyepingyu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  data() {
	...
	zuoyepingyu : false,
      ...
      rules: {
          ...
          zuoyepingfen: [
                { required: true, message: '作业评分不能为空', trigger: 'blur' },
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xueshengxingming = true;
          ...
          if(o=='zuoyepingfen'){
            this.ruleForm.zuoyepingfen = obj[o];
	    this.ro.zuoyepingfen = true;
            continue;
          }
          if(o=='zuoyepingyu'){
            this.ruleForm.zuoyepingyu = obj[o];
	    this.ro.zuoyepingyu = true;
            continue;
          }
        }
      }
